...
func Test매개변수_안전성_검사(테스트 *testing.T) {
	...
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV부호없는_정수(1))
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV정수(1))
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV실수(1))
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV시점(time.Now()))
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV정밀수(1))
	F패닉발생_확인(테스트, F매개변수_안전성_검사, NV통화(KRW, 1))
}
