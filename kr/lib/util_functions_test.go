...
func TestF패닉발생_확인(테스트 *testing.T) {
	...
	테스트_통과 = true
	테스트_결과_반환값 := F패닉발생_확인(가상_테스트, testF매개변수_안정성_검사_패닉)
	...
	테스트_통과 = true
	테스트_결과_반환값 = F패닉발생_확인(가상_테스트, testF매개변수_안정성_검사_정상)
...
func testF매개변수_안정성_검사_패닉() { panic("테스트") }
func testF매개변수_안정성_검사_정상() {}
