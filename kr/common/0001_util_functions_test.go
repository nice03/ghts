...
func TestF큰정수(테스트 *testing.T) {
	...
	fmt.Printf("TODO : %s TestF큰정수()\n\n", F소스코드_위치(1)) //도우미_F큰정수_에러(테스트, NC통화(KRW, 100.025))
...
func TestF정밀수(테스트 *testing.T) {
	...
	fmt.Printf("TODO : %s TestF정밀수()\n\n", F소스코드_위치(1))  //도우미_F정밀수(테스트, NC정밀수(100.025), 예상값)
	
	예상값 = big.NewRat(100, 1)
	fmt.Printf("TODO : %s TestF정밀수()\n\n", F소스코드_위치(1))  //도우미_F정밀수(테스트, NC통화(KRW, 100.025), 예상값)
...
func TestF정밀수_일치(테스트 *testing.T) {
	fmt.Printf("TODO : %s TestF정밀수_일치()\n\n", F소스코드_위치(1))
}
...
func TestF값_일치(테스트 *testing.T) {
	fmt.Printf("TODO : %s TestF값_일치()\n\n", F소스코드_위치(1))
}
